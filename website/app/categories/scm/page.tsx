...
export default function SCMCategoryPage() {
    ...
    const data: Tool[] = [
      {
        ...
        description: "The most popular Git-based repository hosting platform.",
        type: "Free & Paid",
      },
      {
        name: "GitLab",
      ...
      },
      {
        ...
        description: "Git repositories in Azure DevOps Services.",
        type: "Free & Paid",
      },
      {
        name: "Gitea",
      ...
      },
      {
        ...
        description: "Web-based code review and project management for Git projects.",
        type: "Open Source",
      },
      {
        name: "Sourcegraph",
  ...
  return (
    <div className="pt-20 relative">
      {/* Hero Section */}
      <section className="relative py-10 md:py-20 mb-6 md:mb-12 z-10 mx-2 bg-gradient-to-r from-blue-500 to-cyan-600 dark:from-blue-600 dark:to-cyan-700 rounded-3xl overflow-hidden">
