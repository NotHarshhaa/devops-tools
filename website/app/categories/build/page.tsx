...
export default function BuildToolsCategoryPage() {
    ...
    const data: Tool[] = [
      {
        ...
        description: "A comprehensive project management and build tool for Java.",
        type: "Open Source",
      },
      {
        name: "Gradle",
        url: "https://gradle.org/",
        description: "High-performance build automation for Java, Kotlin, Groovy, and more.",
        type: "Open Source",
      },
      {
        name: "npm",
      ...
      },
      {
        ...
        description: "Google's open-source build tool supporting multiple languages.",
        type: "Open Source",
      },
      {
        name: "Make",
        url: "https://www.gnu.org/software/make/",
        description: "Traditional build automation tool that automatically builds executable programs.",
        type: "Open Source",
      },
      {
        name: "Ant",
        url: "https://ant.apache.org/",
        description: "Java-based build tool from Apache that uses XML files.",
        type: "Open Source",
      },
      {
        name: "MSBuild",
        url: "https://github.com/Microsoft/msbuild",
        description: "Microsoft's build platform for Visual Studio and .NET.",
        type: "Open Source",
      },
      {
        name: "Jenkins",
        url: "https://www.jenkins.io/",
        description: "Open source automation server that can be used for building projects.",
        type: "Open Source",
      },
      {
        name: "CMake",
        url: "https://cmake.org/",
        description: "Cross-platform build system generator for C, C++, and Fortran.",
        type: "Open Source",
      },
    ];
  ...
  return (
    <div className="pt-20 relative">
      {/* Hero Section */}
      <section className="relative py-10 md:py-20 mb-6 md:mb-12 z-10 mx-2 bg-gradient-to-r from-green-500 to-teal-600 dark:from-green-600 dark:to-teal-700 rounded-3xl overflow-hidden">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <div className="flex justify-center mb-3 md:mb-5">
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-white/20 backdrop-blur-sm p-4 flex items-center justify-center">
                <CogIcon className="w-full h-full text-white" />
              </div>
            </div>
