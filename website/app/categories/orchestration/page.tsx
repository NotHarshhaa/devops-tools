...
export default function OrchestrationCategoryPage() {
    ...
    const data: Tool[] = [
      {
        ...
        description: "Open-source container orchestration system for automating application deployment and management.",
        type: "Open Source",
      },
      {
        name: "Docker Swarm",
      ...
      },
      {
        ...
        description: "Managed Kubernetes service on AWS without needing to install and operate your own K8s clusters.",
        type: "Paid",
      },
      {
        name: "Google Kubernetes Engine (GKE)",
        url: "https://cloud.google.com/kubernetes-engine",
        description: "Managed Kubernetes service with four-way autoscaling and multi-cluster support.",
        type: "Paid",
      },
      {
        name: "Azure Kubernetes Service (AKS)",
        url: "https://azure.microsoft.com/en-us/services/kubernetes-service/",
        description: "Managed Kubernetes service that simplifies deployment on Azure.",
        type: "Paid",
      },
      {
        name: "OpenShift",
        url: "https://www.openshift.com/",
        description: "Red Hat's enterprise Kubernetes platform for hybrid cloud orchestration.",
        type: "Free & Paid",
      },
      {
        name: "Rancher",
      ...
      },
      {
        ...
        description: "HashiCorp's simple and flexible orchestrator for managing containers and non-containerized applications.",
        type: "Open Source",
      },
      {
        name: "Mesos",
        url: "https://mesos.apache.org/",
        description: "Open-source cluster manager that provides efficient resource isolation and sharing across distributed applications.",
        type: "Open Source",
      },
      {
        name: "Portainer",
        url: "https://www.portainer.io/",
        description: "UI-based container management platform for Docker, Kubernetes, and more.",
        type: "Open Source",
      },
      {
        name: "k3s",
        url: "https://k3s.io/",
        description: "Lightweight Kubernetes distribution designed for IoT and Edge computing.",
        type: "Open Source",
      },
      {
  ...
  return (
    <div className="pt-20 relative">
      {/* Hero Section */}
      <section className="relative py-10 md:py-20 mb-6 md:mb-12 z-10 mx-2 bg-gradient-to-r from-blue-600 to-indigo-700 dark:from-blue-700 dark:to-indigo-800 rounded-3xl overflow-hidden">
