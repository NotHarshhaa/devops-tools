...
export default function SecurityCategoryPage() {
    ...
    const data: Tool[] = [
      {
        name: "Snyk",
        url: "https://snyk.io/",
        description: "Developer security platform to find and fix vulnerabilities in code, dependencies, containers, and IaC.",
        type: "Free & Paid",
      },
      {
        name: "SonarQube",
      ...
      },
      {
        ...
        description: "Cloud native security platform for containers and Kubernetes applications.",
        type: "Paid",
      },
      {
        name: "Checkmarx",
        url: "https://www.checkmarx.com/",
        description: "Application security testing platform that identifies and fixes vulnerabilities in source code.",
        type: "Paid",
      },
      {
        name: "Trivy",
      ...
      },
      {
        ...
        description: "Static analysis tool for vulnerabilities in application containers.",
        type: "Open Source",
      },
      {
        name: "Prisma Cloud",
        url: "https://www.paloaltonetworks.com/prisma/cloud",
        description: "Cloud native security platform for protecting cloud infrastructure and applications.",
        type: "Paid",
      },
      {
        name: "OWASP ZAP",
      ...
      },
      {
        ...
        description: "Container security platform that analyzes, inspects, and certifies container images.",
        type: "Free & Paid",
      },
      {
        name: "Falco",
        url: "https://falco.org/",
        description: "Cloud-native runtime security tool designed to detect anomalous activity in your applications.",
        type: "Open Source",
      },
      {
      ...
      },
      {
        ...
        description: "Application security platform offering multiple testing and scanning technologies.",
        type: "Paid",
      },
    ];
  ...
  return (
    <div className="pt-20 relative">
      {/* Hero Section */}
      <section className="relative py-10 md:py-20 mb-6 md:mb-12 z-10 mx-2 bg-gradient-to-r from-rose-500 to-red-600 dark:from-rose-600 dark:to-red-700 rounded-3xl overflow-hidden">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <div className="flex justify-center mb-3 md:mb-5">
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-white/20 backdrop-blur-sm p-4 flex items-center justify-center">
                <ShieldCheckIcon className="w-full h-full text-white" />
              </div>
            </div>
