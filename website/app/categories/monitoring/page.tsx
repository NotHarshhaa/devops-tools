...
export default function MonitoringCategoryPage() {
  ...
  useEffect(() => {
    ...
    const data: Tool[] = [
      ...
      },
      {
        ...
        description: "Open-source platform for monitoring and observability that allows you to query, visualize, and alert on metrics.",
        type: "Open Source",
      },
      {
        name: "Datadog",
      ...
      },
      {
        ...
        description: "AI-powered, full-stack observability platform for cloud environments.",
        type: "Free & Paid",
      },
      {
        name: "AppDynamics",
        url: "https://www.appdynamics.com/",
        description: "Application performance management and IT operations analytics solution.",
        type: "Paid",
      },
      {
        name: "Nagios",
        url: "https://www.nagios.org/",
        description: "Industry standard for IT infrastructure monitoring.",
        type: "Open Source",
      },
      {
        name: "Zabbix",
      ...
      },
      {
        ...
        description: "A collection of open-source products for search, analysis, and visualization of data.",
        type: "Open Source",
      },
      {
        name: "Sensu",
        url: "https://sensu.io/",
        description: "Multi-cloud monitoring at scale for containers and dynamic infrastructure.",
        type: "Open Source",
      },
      {
        name: "Sentry",
        url: "https://sentry.io/",
        description: "Application monitoring platform that helps identify errors and performance issues in real-time.",
        type: "Free & Paid",
      },
      {
        name: "Jaeger",
        url: "https://www.jaegertracing.io/",
        description: "Open-source, end-to-end distributed tracing system.",
        type: "Open Source",
      },
      {
        name: "Splunk",
      ...
      },
      {
        ...
        description: "Observability tool designed for modern software teams.",
        type: "Free & Paid",
      },
    ];
  ...
  return (
    <div className="pt-20 relative">
      {/* Hero Section */}
      <section className="relative py-10 md:py-20 mb-6 md:mb-12 z-10 mx-2 bg-gradient-to-r from-violet-500 to-purple-600 dark:from-violet-600 dark:to-purple-700 rounded-3xl overflow-hidden">
