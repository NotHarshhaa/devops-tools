...
export default function SecretsManagementCategoryPage() {
    ...
    const data: Tool[] = [
      {
        ...
        description: "Secure, store and tightly control access to tokens, passwords, certificates, and encryption keys.",
        type: "Open Source",
      },
      {
        name: "AWS Secrets Manager",
        url: "https://aws.amazon.com/secrets-manager/",
        description: "Easily rotate, manage, and retrieve database credentials, API keys, and other secrets.",
        type: "Paid",
      },
      {
      ...
      },
      {
        ...
        description: "Universal secrets platform for managing app configuration and secrets across environments.",
        type: "Free & Paid",
      },
      {
      ...
      },
      {
        ...
        description: "Enterprise solution for privileged access security and secrets management.",
        type: "Paid",
      },
      {
        name: "1Password",
        url: "https://1password.com/",
        description: "Password manager that features seamless integration with infrastructure.",
        type: "Paid",
      },
      {
        name: "Keeper",
        url: "https://www.keepersecurity.com/",
        description: "Cybersecurity platform for preventing password-related data breaches and threats.",
        type: "Paid",
      },
      {
        name: "Keywhiz",
  ...
  return (
    <div className="pt-20 relative">
      {/* Hero Section */}
      <section className="relative py-10 md:py-20 mb-6 md:mb-12 z-10 mx-2 bg-gradient-to-r from-slate-500 to-gray-700 dark:from-slate-600 dark:to-gray-800 rounded-3xl overflow-hidden">
