...
export default function AlertingCategoryPage() {
    ...
    const data: Tool[] = [
      {
        ...
        description: "Digital operations management platform for enterprise IT and DevOps teams.",
        type: "Paid",
      },
      {
        name: "OpsGenie",
        url: "https://www.atlassian.com/software/opsgenie",
        description: "Modern incident management platform for operating always-on services.",
        type: "Free & Paid",
      },
      {
        name: "VictorOps",
        url: "https://victorops.com/",
        description: "Incident response platform designed for DevOps-centric teams.",
        type: "Paid",
      },
      {
        name: "AlertManager",
      ...
      },
      {
        ...
        description: "Built-in alerting in Grafana that supports multi-dimensional alerting.",
        type: "Open Source",
      },
      {
        name: "Nagios",
        url: "https://www.nagios.org/",
        description: "Industry standard for IT monitoring with comprehensive alerting capabilities.",
        type: "Open Source",
      },
      {
        name: "Zabbix",
        url: "https://www.zabbix.com/",
        description: "Enterprise-class monitoring solution with advanced alerting functionalities.",
        type: "Open Source",
      },
      {
        name: "xMatters",
        url: "https://www.xmatters.com/",
        description: "Service reliability platform that helps DevOps, SREs, and operations teams automate workflows.",
        type: "Paid",
      },
      {
        name: "Incident.io",
        url: "https://incident.io/",
        description: "Incident management platform that connects with tools you already use.",
        type: "Paid",
      },
      {
        name: "Squadcast",
        url: "https://www.squadcast.com/",
        description: "SRE and DevOps friendly incident management platform.",
        type: "Free & Paid",
      },
      {
        name: "Ilert",
        url: "https://www.ilert.com/",
        description: "Alert management platform for DevOps and SRE teams.",
        type: "Free & Paid",
      },
      {
        name: "FireHydrant",
        url: "https://firehydrant.io/",
        description: "Reliability platform for complex systems with integrated incident management.",
        type: "Paid",
      },
    ];
  ...
  return (
    <div className="pt-20 relative">
      {/* Hero Section */}
      <section className="relative py-10 md:py-20 mb-6 md:mb-12 z-10 mx-2 bg-gradient-to-r from-yellow-500 to-amber-600 dark:from-yellow-600 dark:to-amber-700 rounded-3xl overflow-hidden">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <div className="flex justify-center mb-3 md:mb-5">
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-white/20 backdrop-blur-sm p-4 flex items-center justify-center">
                <BellAlertIcon className="w-full h-full text-white" />
              </div>
            </div>
