...
export default function DevToolsCategoryPage() {
    ...
    const data: Tool[] = [
      {
        ...
        description: "Free, open source code editor with powerful developer tooling.",
        type: "Open Source",
      },
      {
        name: "JetBrains IDEs",
        url: "https://www.jetbrains.com/",
        description: "Professional developer tools with integrated development environments for various languages.",
        type: "Paid",
      },
      {
        name: "GitHub Copilot",
      ...
      },
      {
        ...
        description: "Online code editor and prototyping tool that speeds up the creation and sharing of web apps.",
        type: "Free & Paid",
      },
      {
        name: "Postman",
      ...
      },
      {
        name: "Fig",
        url: "https://fig.io/",
        description: "Command-line tool that adds IDE-style autocomplete to your terminal.",
        type: "Free & Paid",
      },
      {
        name: "GitKraken",
        url: "https://www.gitkraken.com/",
        description: "Git GUI client for Windows, Mac & Linux with intuitive Git visualization.",
        type: "Free & Paid",
      },
      {
        name: "Sourcegraph",
      ...
      },
      {
        ...
        description: "Modern terminal with AI command search and collaborative features.",
        type: "Free & Paid",
      },
      {
        name: "CodeClimate",
      ...
      },
      {
        ...
        description: "Easy-to-install application for building and sharing containerized applications.",
        type: "Free & Paid",
      },
      {
        name: "GitHub Desktop",
  ...
  return (
    <div className="pt-20 relative">
      {/* Hero Section */}
      <section className="relative py-10 md:py-20 mb-6 md:mb-12 z-10 mx-2 bg-gradient-to-r from-fuchsia-500 to-purple-700 dark:from-fuchsia-600 dark:to-purple-800 rounded-3xl overflow-hidden">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <div className="flex justify-center mb-3 md:mb-5">
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-white/20 backdrop-blur-sm p-4 flex items-center justify-center">
                <WrenchIcon className="w-full h-full text-white" />
              </div>
            </div>
